<template>
    <Transition name="fade">
        <div :class="{ 'time-slot': true, 'fade-out': fadeOut }">
            ...
            <div class="static-info" @click="toggleDetails" @mousedown="handleMouseDown" @mouseup="handleMouseUp">
            ...
            <div v-if="isExpanded" class="slot-details">
                ...
                <div class="input-container">
                    <input type="text" v-model="fullName" placeholder="Full Name" class="contact-input"
                        :disabled="isBooking" maxlength="100" />
                    <span class="char-counter">{{ fullName.length }}/100</span>
                </div>

                <div class="input-container">
                    <input type="text" v-model="phoneNumber" @input="validatePhoneNumber" placeholder="Phone Number"
                        class="contact-input" :disabled="isBooking" maxlength="20" />
                    <span class="char-counter">{{ phoneNumber.length }}/20</span>
                </div>

                <div class="input-container">
                    <input type="email" v-model="email" placeholder="Email" class="contact-input" :disabled="isBooking"
                        maxlength="100" />
...
.contact-input {
    ...
    padding: 8px;
    padding-right: 55px;
    /* Space for the character counter */
...
.char-counter {
    ...
    color: #666;
    pointer-events: none;
    /* Ensure the counter doesn't interfere with input */
}
